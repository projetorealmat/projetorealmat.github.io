...
<section class="realmat-library" id="catalogo" aria-label="Catálogo de livros">
  <article class="realmat-library__entry">
    ...
    <div class="realmat-library__body">
      <header>
        <span class="date">Lógica · tradução</span>
        <h2><a href="{{ '/livros/forallx/' | relative_url }}">forallx: Lógica</a></h2>
      </header>
      <p>Uma introdução à lógica formal, traduzida e adaptada para o português brasileiro. A edição atual está em revisão editorial.</p>
      <p class="realmat-meta">Disponível em PDF · acesso aberto</p>
      <ul class="actions">
        <li><a href="{{ '/livros/forallx/' | relative_url }}" class="button primary">Ver a edição</a></li>
        <li><a href="{{ '/assets/books/forallx.pdf' | relative_url }}" target="_blank" rel="noopener noreferrer">Ler o PDF <span aria-hidden="true">↗</span></a></li>
      </ul>
    </div>
  </article>
</section>
