...
<section class="posts realmat-home-posts" aria-label="Caminhos do portal">
  <article>
    ...
    <ul class="actions special">
      <li><a href="{{ '/livros/' | relative_url }}" class="button">Abrir a biblioteca</a></li>
    </ul>
  </article>
  ...
  <article>
    ...
    <ul class="actions special">
      <li><a href="{{ '/contribuir/' | relative_url }}" class="button">Como contribuir</a></li>
    </ul>
  </article>
  ...
  <article>
    ...
    <ul class="actions special">
      <li><a href="{{ '/buscar/' | relative_url }}" class="button">Buscar no portal</a></li>
    </ul>
  </article>
</section>
